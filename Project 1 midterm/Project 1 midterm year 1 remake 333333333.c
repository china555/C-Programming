...
int tmp[10][4];
int sumarray = 0;
int foodtable[10][100],drinktable[10][100];
...
int Order()
{
    ...
    printf("\n\nEnter the table number [1-10] (0 to exit): ");
    scanf("%d",&tabletrue);
    if(a[0][tabletrue-1] == 1)
        {
            if (tabletrue == 0)
                {
                    main();
                }
            else if(tabletrue < 0 || tabletrue >10)
                {
